...
levels = [##             num   start_loc         start_range      astd_sp rng  miss#  sp     start_locn   n_good n_miss miss_sp thsh g_a  g_m
          ...
          Level(0.16, 8, (0.0,0.0,100.0),  (200.0,200.0,100.0), 0.12, 0.02, 0, 0.12, (-1500.0,0.0,0.0),  0,   3,   1.0,    2.0, 0.0, 0.0, (500, 10, 100)),
          Level(0.18, 9, (0.0,0.0,100.0),  (200.0,200.0,100.0), 0.13, 0.02, 0, 0.13, (-1500.0,0.0,0.0),  0,   3,   1.0,    2.0, 0.0, 0.0, (100, 50, 10)),
          Level(0.2, 10,(0.0,0.0,100.0),  (200.0,200.0,100.0), 0.14, 0.02, 0, 0.14, (-1500.0,0.0,0.0),  0,   3,   1.0,    2.0, 0.0, 0.0, (100, 20, 100)),
          ...
          Level(0.32, 7, (-50.0,0.0,100.0), (200.0,200.0,100.0),  0.13, 0.1, 1, 0.2, (-1000.0,0.0,0.0),  0,   3,   0.4,    3.0, 0.3, 0.0, (10, 50, 100)),
          Level(0.34, 8, (-50.0,0.0,100.0), (200.0,200.0,100.0),  0.13, 0.1, 1, 0.2, (-1000.0,0.0,0.0),  0,   3,   0.4,    3.0, 0.3, 0.0, (50, 10, 100)),
          Level(0.36, 9, (-50.0,0.0,100.0), (200.0,200.0,100.0),  0.14, 0.1, 1, 0.24, (-1000.0,0.0,0.0), 0,   3,   0.4,    3.0, 0.3, 0.0, (20, 50, 100)),
          Level(0.38, 10,(-50.0,0.0,100.0), (200.0,200.0,100.0),  0.15, 0.1, 1, 0.25, (-1000.0,0.0,0.0), 0,   3,   0.4,    2.0, 0.3, 0.0, (100, 20, 200)),
          Level(0.4, 10,(-50.0,0.0,100.0), (200.0,200.0,100.0),  0.16, 0.1, 1, 0.25, (-1000.0,0.0,0.0), 0,   3,   0.4,    2.0, 0.3, 0.0, (150, 20, 200)),
          ...
          Level(0.54, 8, (-100.0,0.0,200.0), (300.0,200.0,100.0), 0.64, 0.1, 2, 0.55, (-500.0,0.0,-200.0),0,  3,   0.88,  7.0, 0.2, 0.4, (20, 20, 100)),
          Level(0.56, 9, (-100.0,0.0,200.0), (300.0,200.0,100.0), 0.7, 0.2, 2, 0.55, (-500.0,0.0,-200.0), 0,  3,   0.88,  6.0, 0.2, 0.5, (20, 100, 50)),
          Level(0.58, 9, (-100.0,0.0,200.0), (300.0,200.0,100.0), 0.75, 0.2, 2, 0.85, (-500.0,0.0,-200.0),0,  3,   0.92,  6.0, 0.2, 0.5, (200, 20, 100)),
          Level(0.6, 10,(-100.0,0.0,200.0), (300.0,200.0,100.0), 0.8, 0.2, 2, 0.85, (-500.0,0.0,-200.0), 0,  3,   0.95,  5.0, 0.3, 0.5, (200, 20, 200)),
          ...
          Level(0.76, 8, (-100.0,0.0,100.0), (100.0,200.0,200.0), 0.82, 0.3, 3, 1.15, (0.0,0.0,-500.0),  0,   3,   1.4,   5.0, 0.3, -0.1, (50, 150, 100)),
          Level(0.78, 9, (-100.0,0.0,100.0), (100.0,200.0,300.0), 0.84, 0.3, 3, 1.25, (0.0,0.0,-500.0),  0,   3,   1.4,   5.0, 0.3, -0.1, (20, 50, 500)),
          Level(0.8, 10,(-100.0,0.0,100.0), (100.0,200.0,300.0), 0.86, 0.3, 3, 1.25, (0.0,0.0,-500.0),  0,   3,   1.4,   5.0, 0.3, -0.2, (250, 20, 400)),
          ...
          Level(0.88, 5, (-300.0,0.0,100.0), (100.0,200.0,100.0), 0.9, 0.1, 4, 1.00, (500.0,0.0,-500.0), 0,   2,   1.2,    4.0, 1.8, 12.8, (20, 20, 100)),
          Level(0.9, 6, (-300.0,0.0,100.0), (100.0,200.0,100.0), 0.9, 0.1, 4, 1.00, (500.0,0.0,-500.0), 0,   2,   1.2,    4.0, 1.8, 12.8, (50, 50, 100)),
          Level(0.92, 7, (-300.0,0.0,100.0), (100.0,200.0,100.0), 0.9, 0.1, 4, 1.00, (500.0,0.0,-500.0), 0,   2,   1.2,    4.0, 1.8, 12.8, (80, 100, 50)),
          Level(0.94, 8, (-300.0,0.0,100.0), (100.0,200.0,100.0), 0.9, 0.1, 4, 1.00, (500.0,0.0,-500.0), 0,   3,   1.2,    4.0, 1.8, 12.8, (50, 20, 200)),
          Level(0.96, 9, (-300.0,0.0,100.0), (100.0,200.0,100.0), 0.9, 0.1, 4, 1.00, (500.0,0.0,-500.0), 0,   3,   1.1,    4.0, 1.8, 12.8, (100, 500, 100)),
          Level(0.98, 10,(-300.0,0.0,100.0), (100.0,200.0,100.0), 0.9, 0.1, 4, 1.00, (500.0,0.0,-500.0), 0,   3,   1.1,    4.0, 1.8, 12.8, (20, 50, 500)),
          Level(1.0, 10,(-300.0,0.0,100.0), (100.0,200.0,100.0), 0.9, 0.1, 4, 1.00, (500.0,0.0,-500.0), 0,   3,   1.1,    4.0, 1.8, 12.8, (400, 20, 400))
         ]
